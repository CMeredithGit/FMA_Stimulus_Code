classdef PR_FictiveHunting < protocols.protocol
...
%% Set properties
    ...
    methods (Access = public)
        function o = PR_FictiveHunting(winPtr)
            o = o@protocols.protocol(winPtr);
        end
        
        function initFunc(o, S, P)
            fprintf('Initializing PR_FictiveHunting...\n');
...
%% Run prep_run_trial
        function [FP, TS] = prep_run_trial(o)
            ...
            fprintf('1 = SW | 2 = SE | 3 = NW | 4 = NE\n');
            validInput = false;
            while ~validInput
                startChoice = input('Select START corner: ', 's');
                switch startChoice
                    case '1'
                        o.startSW = true; o.startSE = false; o.startNW = false; o.startNE = false;
                        validInput = true;
                    case '2'
                        o.startSW = false; o.startSE = true; o.startNW = false; o.startNE = false;
                        validInput = true;
                    case '3'
                        o.startSW = false; o.startSE = false; o.startNW = true; o.startNE = false;
                        validInput = true;
                    case '4'
                        o.startSW = false; o.startSE = false; o.startNW = false; o.startNE = true;
                        validInput = true;
                    otherwise
            ...
            validInput = false;
            while ~validInput
                targetChoice = input('Select TARGET corner: ', 's');
                switch targetChoice
                    case '1'
                        o.targetSW = true; o.targetSE = false; o.targetNW = false; o.targetNE = false;
                    case '2'
                        o.targetSW = false; o.targetSE = true; o.targetNW = false; o.targetNE = false;
                    case '3'
                        o.targetSW = false; o.targetSE = false; o.targetNW = true; o.targetNE = false;
                    case '4'
                        o.targetSW = false; o.targetSE = false; o.targetNW = false; o.targetNE = true;
                    otherwise
                        fprintf('Invalid choice. Try again.\n');
                        continue;
                end
            ...
            % Update targetX/Y/Size based on selection
            if o.targetSW
                o.targetX = o.endZones(1, 1); o.targetY = o.endZones(1, 2); o.targetSize = o.endZones(1, 3);
            elseif o.targetSE
                o.targetX = o.endZones(2, 1); o.targetY = o.endZones(2, 2); o.targetSize = o.endZones(2, 3);
            elseif o.targetNW
                o.targetX = o.endZones(3, 1); o.targetY = o.endZones(3, 2); o.targetSize = o.endZones(3, 3);
            elseif o.targetNE
                o.targetX = o.endZones(4, 1); o.targetY = o.endZones(4, 2); o.targetSize = o.endZones(4, 3);
            end
            
            fprintf('Start and Target corners assigned. Waiting for "B" key to begin...\n');
            ...
            fprintf('\nWaiting for user to press "B" to begin trial...\n');
            while ~o.manualStart
