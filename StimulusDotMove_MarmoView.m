function [S, P] = StimulusDotMove_MarmoView()
    ...
    S.protocol = 'StimulusDotMove_MarmoView';
    S.protocol_class = ['protocols.PR_', S.protocol];
    S.protocolTitle = 'Stimulus Dot Movement';

    % Trial settings
    S.finish = 100; % Number of trials to run

    % Stimulus parameters
    P.dotSize = 8; % Dot size in pixels
    ...
    P.manualTrials = 1;
    S.manualTrials = 'Toggle manual trials';
end
